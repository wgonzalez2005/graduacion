...
<body class="main-layout">
        ...
        <div class="container-fluid">
            <div class="row d_flex">
                <div class="col-md-4">
                    ...
                    <h1 class="text-center" style="background-color:#13110e ;color:white;padding:10px;">Graduandos por Familia</h1>
                ...
                <div class="col-md-8">
                   ...
                   <div class="container-fluid contenedor-tabla">
                   <h1 class="text-center" style="background-color:#13110e ;color:white;padding:10px;">Listado Graduandos por Familia</h1>
                   <table class="table  table-striped">
                       <thead class="header-table">
                           <tr>
                               <th scope="col">ID</th>
    ...
    <script src="<?php echo RUTA; ?>public/app/familias.js"></script>
</body>
