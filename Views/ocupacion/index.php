...
<head>
    ...
    <!-- site metas -->
    <title>Graduación Infotep 2022</title>
...
<body class="main-layout">
        ...
        <div class="container-fluid">
            ...
            <div class="row d_flex">
                <div class="col-md-5">
                    ...
                    <h1 class="text-center" style="background-color:#13110e ;color:white;padding:10px;">Graduandos por Ocupación</h1>
                    <table class="table  table-striped">
                        <thead class="header-table">
                            <tr>
                                ...
                                <th class="text-center" scope="col">AUSENTES</th>
                                <th class="text-center" scope="col">VER</th>
                            </tr>
                        </thead>
                        <tbody id="datosocupacion">
                ...
                <div class="col-md-7">
                       ...
                       <div class="container-fluid contenedor-tabla">
                       <h1 class="text-center" style="background-color:#13110e ;color:white;padding:10px;">Listado Presente</h1>
                       <table class="table  table-striped">
                           <thead class="header-table">
                               <tr>
                                   <th scope="col">ID</th>   
    ...
    <script src="<?php echo RUTA; ?>public/app/ocupacion.js"></script>
</body>
